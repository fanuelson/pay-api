...
public class NotificationServiceImpl implements NotificationService {
  ...
  public void notify(Long userId, String email, String message) {
    ...
    try {
      final var response = restClient.post()
        ...
        .onStatus(HttpStatusCode::is4xxClientError, (req, res) -> {
          ...
          throw new AppException("Client error: " + res.getStatusCode());
        })
        .onStatus(HttpStatusCode::is5xxServerError, (req, res) -> {
          log.error("Server error: {}", res.getStatusCode());
          throw new AppException("Server error: " + res.getStatusCode());
        })
        .toBodilessEntity();
      ...
      if (response.getStatusCode().is2xxSuccessful()) {
        ...
        throw new AppException("Notification error, status: " + response.getStatusCode());
      }
    } catch (Exception ex) {
